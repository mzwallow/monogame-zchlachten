...
namespace Zchlachten.Screens
{
    public class TutorialScreen : Screen
    {
        ...
        private String _infoGuide = "เป็นเกมแบบเล่น 2 คน ปล่อยพลังใส่กันโดย\n-ใช้เมาท์ในการกำหนดองศาที่จะยิง\n-คลิกค้างเพื่อกำหนดความแรงของการปล่อยพลัง และปล่อยคลิกเมื่อได้ความแรงที่ต้องการ\n-มีระบบ buff จะสุ่มขึ้นมาบนอากาศโดยถ้าเก็บได้จะมีผลในเทิร์นถัดไป \nแต่ถ้ายิงโดยศัตรูด้วยจะได้โบนัส จะโดนสถานะนั้นทันที และเทิร์นหน้าที่ยังใช้ได้อยู่\n-มีระบบ itemเริ่มต้น โดยจะมี 3 item พรของต้นไม้โลก โล่ และน้ำศักดิ์สิทธิ์ ใช้ได้ชิ้นล่ะ 1 ครั้ง\n-มีระบบ อาวุธพิเศษ โดยจะได้ก็ต่อโดยเรายิงโดนศัครู2ครั้งจะได้1ชิ้น เก็บได้2ชิ้น ";
        ...
        private String _textHolyWater = "น้ำศักดิ์สิทธิ์ น้ำที่ได้จากทะเลสาบศักดิ์สิทธิ์ใกล้กับต้นไม้โลก ถ้ามีความสามารถในการลบสถานะผิดปกติทั้งหมด \nสามาถลบสถานะทั้งหมดทั้งที่ดีและไม่ดี";
